...
# ---------------------- Global varibales ---------------------- #
file = "TSLA.csv"
threeObjectives = False # Set to true if three objectives are to be used.
notification = False
resolution = "5m"
...
def simulation(individual):
    ...
    startDate = '2021-03-01 08:00:00' # Start date of the overall trading window.
    endDate = '2021-03-18 17:00:00' # End date of the overall trading window.
    ...
    pcSplit =  17 # The number of intervals to split the trading window into for PC
    ...
    # for i in performanceConsistencyDates:
    #     print(i)
...
if __name__ == "__main__":
    trainingStart = "2021-03-01" # Put these dates into the simulation function!
    trainingEnd = "2021-03-18"
    unseenStart = "2021-03-19 08:00:00"
    unseenEnd = "2021-03-19 17:00:00"
    freeze_support()
    random.seed()
