...
def simulation(individual):
    ...
    startDate = '2019-06-01' # Start date of the overall trading window.
    endDate = '2020-01-01' # End date of the overall trading window.
    ...
    return round(answer,2), pcCount, #numTrades,# riskExposure,
...
if __name__ == "__main__":
    trainingStart = "2017-01-01" # Put these dates into the simulation function!
